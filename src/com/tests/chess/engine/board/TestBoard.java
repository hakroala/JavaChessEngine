...
public class TestBoard {
    ...
    public void initialBoard()
    {
        ...
        assertEquals(board.currentPlayer().getLegalMoves().size(), 43);
        assertEquals(board.currentPlayer().getOpponent().getLegalMoves().size(), 44);
    ...
    public void testFoolMate()
    {
        ...
        final MoveTransition t2 = t1.getTransitionBoard()
                                .currentPlayer()
                                .makeMove(Move.MoveFactory
                                .createMove(t1.getTransitionBoard(),BoardUtils.getCoordinateAtPosition("e7"),BoardUtils.getCoordinateAtPosition("e5")));

        assertTrue(t2.getMoveStatus().isDone());
        final MoveTransition t3 = t2.getTransitionBoard()
                                    .currentPlayer()
                                    .makeMove(Move.MoveFactory
                                    .createMove(t2.getTransitionBoard(),BoardUtils.getCoordinateAtPosition("g2"),BoardUtils.getCoordinateAtPosition("g4")));
